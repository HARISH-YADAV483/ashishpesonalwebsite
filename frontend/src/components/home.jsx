    ...
    return (
        <div className="parentu" style={{ backgroundImage: `url(${bag})` }}>
            <div className="parent">
                ...
                <div className="card">
                    <a className="socialContainer containerOne" href="https://www.instagram.com/ashishpuhaniya_?igsh=MWFiaGJ2MjZmdG5vaw==">
                    ...
                    <a className="socialContainer containerThree" href="https://www.linkedin.com/in/ashishpuhaniya-?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                    ...
                    <a className="socialContainer containerFour" href="mailto:ashishpuhaniya00@gmail.com">
                        <svg
                            viewBox="0 0 16 16"
                            fill="currentColor"
                            height="16"
